...
import handwriting.learners.RecognizerSOM;
...
public class DrawingEditorControllerOld {
	@FXML
	Button clear;
	...
	void saveDataFile() {
		...
		chooser.setInitialDirectory(new File("src/handwriting/"));
	...
	void runTests(SampleData testData) {
		...
		if(trainer.getClass().isInstance(new RecognizerSOM())){
			((RecognizerSOM)trainer).printStats(percent);
		}
	}
